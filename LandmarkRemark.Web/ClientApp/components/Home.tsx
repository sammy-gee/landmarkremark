        ...
        return <div>
            ...
            <p>
                ...
                <h3>Functional</h3>
                    ...
                    <li>Currently the map only centres based on the user's current location. Ideally it should centre based on numerous actions. Example if a user clicks on one of the search results in the list below, the map would re-centre (and highlight) to that landmark remark marker.</li>
            ...
            <h2>Observations</h2>
                <p>
                    ...
                    Still quite a bit to learn about React but it was a good start to the technology. 
                </p>
        </div>;
    }
}
